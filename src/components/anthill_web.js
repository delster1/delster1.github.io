import init, { Universe, Cell } from "./pkg/anthill.js";
// import {memory} from "../pkg/anthill_bg.js"
// import { memory } from "../pkg/anthill/anthill_bg.js";
...
async function run() {
	...
	const drawCells = () => {
		...
		const ants = new Uint32Array(wasm.memory.buffer, antsPtr, antsCount * 2);
